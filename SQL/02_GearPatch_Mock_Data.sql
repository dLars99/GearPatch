...
Maecenas tristique, est et tempus semper, est quam pharetra magna, ac consequat metus sapien ut nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam. Suspendisse potenti.', 79, 1, 'https://media.musicarts.com/is/image/MMGS7/483836000088112-00-600x600.jpg', 4, 8, null, null);
...
Curabitur at ipsum ac tellus semper interdum. Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam.', 55, 0, 'https://images-na.ssl-images-amazon.com/images/I/41-yCeOIrFL._AC_.jpg', 3, 15, '12', 300);
...
insert into Gear (id, Headline, Manufacturer, Model, Description, Price, IsActive, ImageLocation, UserProfileId, GearTypeId, FirstOptionNotes, SecondOptionNotes) values (5, 'Gorgeous guitar for careful renters', 'Taylor', '814ce', null, 127, 1, 'https://cdn.shopify.com/s/files/1/0240/9767/products/814ce_9096a_1024x1024.JPG?v=1560562964', 3, 2, '12', 'I put new strings on each time');
...
Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.', 88, 1, 'https://media.sweetwater.com/api/i/q-82__ha-4133ab3992756f47__hmac-6a139f6a93167ee969f3a01d04e313d7bd740a13/images/items/750/ProFX16v3-large.jpg', 9, 14, '16', null);
...
Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.', 334, 1, 'https://thumbs.worthpoint.com/zoom/images2/360/1112/30/eclipse-original-mr-bb-trumpet_360_a8f90775fd859e404c245e68b975810c.jpg', 4, 8, null, null);
...
Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.', 182, 0, 'https://img.audiofanzine.com/images/u/product/normal/yamaha-emx68s-17923.jpg', 6, 13, '6', 'yes');
insert into Gear (id, Headline, Manufacturer, Model, Description, Price, IsActive, ImageLocation, UserProfileId, GearTypeId, FirstOptionNotes, SecondOptionNotes) values (11, 'Let er ring!', 'Zildjian', 'DCP Ride', null, 80, 1, 'https://www.drumcenternh.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/z/i/zil-player-1_1.jpg', 5, 6, '20', null);
...
insert into UserMessage (Id, SenderId, RecipientId, CreateDateTime, Content, Unread) values (7, 5, 1, '2020-03-12 18:22:19', 'In sagittis dui vel nisl.', 0);
insert into UserMessage (Id, SenderId, RecipientId, CreateDateTime, Content, Unread) values (8, 8, 1, '2019-11-20 05:29:55', 'Mauris lacinia sapien quis libero. Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh.', 0);
insert into UserMessage (Id, SenderId, RecipientId, CreateDateTime, Content, Unread) values (9, 5, 1, '2020-07-15 04:50:34', 'Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque. Quisque porta volutpat erat.', 1);
insert into UserMessage (Id, SenderId, RecipientId, CreateDateTime, Content, Unread) values (10, 1, 9, '2019-09-01 09:51:14', 'Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Mauris viverra diam vitae quam.', 0);
...
insert into UserMessage (Id, SenderId, RecipientId, CreateDateTime, Content, Unread) values (15, 8, 1, '2020-05-23 16:21:52', 'Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla.', 0);
...
insert into UserMessage (Id, SenderId, RecipientId, CreateDateTime, Content, Unread) values (18, 3, 1, '2019-04-20 02:48:06', 'Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus. Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis.', 1);
