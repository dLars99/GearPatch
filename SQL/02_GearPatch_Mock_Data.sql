...
insert into Gear (id, Headline, Manufacturer, Model, Description, Price, IsActive, ImageLocation, UserProfileId, GearTypeId, FirstOptionNotes, SecondOptionNotes) values (5, 'Gorgeous guitar for careful renters', 'Taylor', '814ce', null, 127, 1, '../media/gear-images/814ce.jpg', 3, 2, '12', 'I put new strings on each time');
...
Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.', 88, 1, '../media/gear-images/mackiemixer.jpg', 9, 14, '16', null);
